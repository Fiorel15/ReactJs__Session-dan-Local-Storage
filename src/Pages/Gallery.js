...
class Gallery extends React.Component{
    ...
    Edit = (item) => {
        ...
        this.setState({
            ...
            action: "update",
            selectedItem: item,
            isbn: tempBuku[index].isbn,
            judul: tempBuku[index].judul,
            penulis: tempBuku[index].penulis,
            penerbit: tempBuku[index].penerbit,
            cover: tempBuku[index].cover,
            harga: tempBuku[index].harga,
        })
    }
    ...
    // Fungsi untuk penerapan SESSION SOTARGE
    setUser = () => {
        // cek eksistesi dari session storage
    ...
    addToCart = (selectedItem) => {
        // membuat variabel u/ menampung cart sementara
        let tempCart = []

        //cek eksistensi dari data cart pada localStorage
        if(localStorage.getItem("cart") !== null) {
            tempCart = JSON.parse(localStorage.getItem("cart"))
                // JSON.parse() digunakan u/ mengkonversi dr string ke array object
        }
        ...
        if(existItem) {
            // jika item yg dipilih ada di keranjang belanja mk menjalankan berikut.
            ...
            if(promptJumlah !== null && promptJumlah !== " ") {
                ...
                // menambahkan properti "jumlahBeli" pd item yg dipilih
        ...
        return(
            <div className="container">
                <div className="row">
                    ...
                    <div className="row wow fadeInUp animated"  data-wow-duration="500ms">
